...
enum class MatroskaTags(val byteArray: ByteArray) {
    ...
    MaxBlockAdditionID(byteArrayOf(0x55.toByte(), 0xEE.toByte())),
    AlphaMode(byteArrayOf(0x53.toByte(), 0xC0.toByte())),
    Colour(byteArrayOf(0x55.toByte(), 0xB0.toByte())),
    ...
    companion object {
        ...
        /** バイト配列から [MatroskaTags] を取得する */
        fun find(byteArray: ByteArray) = values().firstOrNull { it.byteArray.contentEquals(byteArray) }
